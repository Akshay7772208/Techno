...
const Home = () => {
    ...
    const Images=[
        'https://www.technobridge.in/assets/images/clients/cognizant.webp',
        'https://www.technobridge.in/assets/images/clients/GIMmd.webp',
        'https://www.technobridge.in/assets/images/clients/cognizant.webp',
        'https://www.technobridge.in/assets/images/clients/cognizant.webp',
        'https://www.technobridge.in/assets/images/clients/cognizant.webp',
        'https://www.technobridge.in/assets/images/clients/cognizant.webp',
  ...
  return (
    ...
    <div className="desknav showdesk ">
        <div className="navwrap">
            ...
            <ul className="navmenud">
                ...
                <li className="navitem"><a href="#s" className="dropicon">Blogs <i
                            className="fa-solid fa-caret-down"></i></a>
                    <ul className="dropmenu">
    ...
    <div className="mobilenav showmob">
        ...
        <div className="typing-container">
            <p>
                Course in <span className="typed-text"></span><span className="cursor">&nbsp;</span>
            </p>
            <div className="tagline">
                <h3>Bridging The Technologies</h3>
            </div>
            <a href="tel:+919257035703" className="btn register" style={{width:'200px'}}>Learn More</a>
        </div>
    </section>
        <Learning/>
        <Key/>
